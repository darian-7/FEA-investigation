...
hold on
xlabel('Crack orientation (degrees)','Fontsize',16);
ylabel('Additional stress "P" (MPa)','Fontsize',16);
set(gca,'fontsize',16)
% ylabel(colorbar, 'Stress Intensity Factor [MPa√m]', 'Fontsize', 16);
hold off
% 
...
[X,Y] = meshgrid(orien_angle,sig_p_plot);
figure
c = contourf(X,Y,LEFM_validity.*10^3,'ShowText',true,'LevelStep',1.25);
hold on
a = colorbar
xlabel('Crack orientation (degrees)','Fontsize',16);
ylabel('Additional stress "P" (MPa)','Fontsize',16);
a.Label.String = 'Stress Intensity Factor';
set(gca,'fontsize',16)
hold off
...
[X,Y] = meshgrid(orien_angle,sig_p_plot);
figure
c = contourf(X,Y,max_k,'ShowText',true,'LevelList',20);
hold on
xlabel('Crack orientation (degrees)','Fontsize',16);
ylabel('Additional stress "P" (MPa)','Fontsize',16);
set(gca,'fontsize',16)
...
figure
y1 = tresca_SF;
plot(sig_p_plot,y1,'Linewidth',2);
hold on
y2 = vonmises_SF;
plot(sig_p_plot,y2,'Linewidth',2);
hold off
yline(1,'Linewidth',2);
xlabel('Additional stress "P" (MPa)','Fontsize',16);
ylabel('Safety factor','Fontsize',16);
% yline(2);
legend('Tresca stress','Von Mises stress','Location','southeast','Fontsize',16)
set(gca,'fontsize',16)
...
xlabel('Additional stress "P" (MPa)','Fontsize',16);
ylabel('Equivalent stress (MPa)','Fontsize',16);
legend('Von Mises stress','Tresca stress','Fontsize',16)
set(gca,'fontsize',16)
