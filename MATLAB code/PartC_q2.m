...
while a <= af
    ...
    paris2(n2,2) = 1 - fn_pod(2049155,a*1000); % prob of not detection cracks above this radius

    paris2(n2,3) = fn_pod(2049155,a*1000); % prob of detection
